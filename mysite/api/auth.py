...
from mysite.database.schema import UserProfileOutSchema, UserProfileInputSchema, UserLoginSchema
 ...
 #   to_encode = data.copy()
  #  if expires_delta:
   #     expire = datetime.utcnow() + expires_delta
    #else:
     #   expire = datetime.utcnow() + timedelta(minutes=ACCESS_TOKEN_EXPIRE_LIFETIME)
